...
public abstract class TestNoAuth {
	 ...
	 */
	@Test
	void testFindMetadataByCampaign() {
		get("api/campaign/simpsons2020x00/metadata")
		.then().statusCode(200);
	}
	/**
	 ...
	 */
	@Test
	void testFindMetadataByUnexistCampaign() {
		get("api/campaign/toto/metadata")
		.then().statusCode(404);
	}
	//////////////////////////	API_CAMPAIGN_ID_METADATA //////////////////////////
	...
	void testFindRequiredNomenclatureByCampaign() {
		get("api/campaign/simpsons2020x00/required-nomenclatures")
		.then().statusCode(200)
	 ...
	 */
	@Test
	void testFindSurveyUnitById() {
		get("api/survey-unit/11")
		.then().statusCode(200);
	}
	 ...
	 */
	@Test
	void testFindSurveyUnitByUnexistId() {
		get("api/survey-unit/test")
		.then().statusCode(404);
	}
	//////////////////////////	API_SURVEYUNIT_ID //////////////////////////
	...
	@Test
	void testFindQuestionnaireById() {
		get("api/questionnaire/simpsons")
		.then().statusCode(200);
	}
	
	@Test
	void testFindQuestionnaireByUnexistId() {
		get("api/questionnaire/test")
		.then().statusCode(404);
	}
	//////////////////////////	API_QUESTIONNAIRE_ID //////////////////////////
	...
	@Test
	void testFindMetadataByQuestionnaireId() {
		get("api/questionnaire/simpsons/metadata")
		.then().statusCode(200);
	}
	
	@Test
	void testFindMetadataByUnexistQuestionnaireId() {
		get("api/questionnaire/test/metadata")
		.then().statusCode(404);
	}
	//////////////////////////	API_QUESTIONNAIRE_ID_METADATA //////////////////////////
	...
	@Test
	void testFindRequiredNomenclatureByQuestionnaireId() {
		get("api/questionnaire/simpsons/required-nomenclatures")
		.then().statusCode(200);
	}
	
	@Test
	void testFindRequiredNomenclatureByUnexistQuestionnaireId() {
		get("api/questionnaire/test/required-nomenclatures")
		.then().statusCode(404);
	}
	//////////////////////////	API_QUESTIONNAIRE_ID_REQUIREDNOMENCLATURE //////////////////////////

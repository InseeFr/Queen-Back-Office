...
//		assert	result.getStatusCode().is2xxSuccessful():"error status will be 200";
//		assert List.of(result.getBody()).stream().anyMatch(o -> o.getModel()!=null):"QuestionnaireModel 'simpsons' should have jsonb model";
//	}
//	
//	@Test
...
//		assert	result.getStatusCode().is2xxSuccessful():"error status will be 200";
//		assert List.of(result.getBody()).stream().anyMatch(o -> o.getValue()!=null):"Nomenclature 'cities2019' should have jsonb model";
//	}
//	
//	@Test
...
//		assert	result.getStatusCode().is2xxSuccessful():"error status will be 200";
//		assert List.of(result.getBody()).stream().anyMatch(o -> o.getValue()!=null):"Comment for reporting unit '22' should exist";
//	}
//	
//	@Test
...
//		assert	result.getStatusCode().is2xxSuccessful():"error status will be 200";
//		assert List.of(result.getBody()).stream().anyMatch(o -> o.getValue()!=null):"Data for reporting unit '22' should exist";
//	}
//	
//	@Test

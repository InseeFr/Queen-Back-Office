	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		if (this.applicationProperties.getMode() == Mode.basic) {
			...
			http.authorizeRequests()
					...
					.antMatchers(HttpMethod.GET, Constants.API_SURVEYUNITS).hasAnyRole(roleAdmin, roleInterviewer, roleReviewer)
					...
					.antMatchers(HttpMethod.GET, Constants.API_NOMENCLATURES).hasAnyRole(roleAdmin, roleInterviewer, roleReviewer)

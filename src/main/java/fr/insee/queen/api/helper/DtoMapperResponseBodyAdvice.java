...
public class DtoMapperResponseBodyAdvice extends AbstractMappingJacksonResponseBodyAdvice {
    ...
    public boolean supports(MethodParameter returnType, Class<? extends HttpMessageConverter<?>> converterType) {
        return super.supports(returnType, converterType) && returnType.hasMethodAnnotation(DtoHelper.class);
    }
    ...
    protected void beforeBodyWriteInternal(MappingJacksonValue bodyContainer, MediaType contentType,
        ...
        DtoHelper ann = returnType.getMethodAnnotation(DtoHelper.class);
        validate(ann);
    ...
    private void validate(DtoHelper ann) {

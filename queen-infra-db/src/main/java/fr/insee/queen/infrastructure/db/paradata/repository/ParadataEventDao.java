...
public class ParadataEventDao implements ParadataEventRepository {
    ...
    @Override
    public void createParadataEvent(UUID id, ObjectNode paradataValue, String interrogationId) {
        jpaRepository.createParadataEvent(id, paradataValue, interrogationId);
    }
}

...
public class PilotageFakeRepository implements PilotageRepository {
    ...
    public static final String INTERROGATION1_ID = "pilotage-su-1";
    public static final String INTERROGATION2_ID = "pilotage-su-2";
    public static final String INTERROGATION3_ID = "pilotage-su-2";

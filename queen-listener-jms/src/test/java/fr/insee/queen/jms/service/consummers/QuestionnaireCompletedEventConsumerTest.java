...
class QuestionnaireCompletedEventConsumerTest {
    ...
    @InjectMocks
    private QuestionnaireCompletedEventConsumer consumer;
    ...
    @Test
    void shouldProcessQuestionnaireCompletedEvent() throws StateDataInvalidDateException {
        // Given
    ...
    @Test
    void shouldNotProcessNonQuestionnaireCompletedEvents() {
        // Given
        EventPayloadDto payload = new EventPayloadDto();
        payload.setInterrogationId(INTERROGATION_ID);

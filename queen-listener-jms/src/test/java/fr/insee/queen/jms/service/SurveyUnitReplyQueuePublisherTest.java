...
class SurveyUnitReplyQueuePublisherTest {
    ...
    @InjectMocks
    private SurveyUnitReplyQueuePublisher surveyUnitReplyQueuePublisher;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        surveyUnitReplyQueuePublisher = new SurveyUnitReplyQueuePublisher(objectMapper, jmsQueuePublisher);
    }
    ...
    void shouldLogInfoAndSendMessageSuccessfully(CapturedOutput output) throws Exception {
        ...
        JmsResponse responseMessage = JmsResponse.createResponse(responseCode);
    ...
    void shouldLogErrorWhenJsonProcessingExceptionOccurs(CapturedOutput output) throws Exception {
        ...
        String replyQueue = "replyQueue";
        String correlationId = "12345";
        JmsResponse responseMessage = JmsResponse.createResponse(ResponseCode.CREATED);

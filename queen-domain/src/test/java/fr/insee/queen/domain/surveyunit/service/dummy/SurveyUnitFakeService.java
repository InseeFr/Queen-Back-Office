...
public class SurveyUnitFakeService implements SurveyUnitService {
    ...
    public List<SurveyUnit> findAllSurveyUnits() {
        return List.of(
                SurveyUnit.create(SURVEY_UNIT1_ID, "campaign-id", "questionnaire-id", null, null, null, null),
                SurveyUnit.create(SURVEY_UNIT2_ID, "campaign-id", "questionnaire-id", null, null, null, null)
        );
    }
}

...
public interface StateDataService {
    ...
    void saveStateData(String interrogationId, StateData stateData, boolean verifyDate, boolean verifyTransition) throws StateDataInvalidDateException, StateDataInvalidTransitionException;

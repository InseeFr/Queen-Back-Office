...
public class PersonalizationController {
    ...
    @GetMapping(path = {"/survey-unit/{id}/personalization", "/interrogation/{id}/personalization"})
    ...
    @PutMapping(path = {"/survey-unit/{id}/personalization", "/interrogation/{id}/personalization"})

...
public class StateDataController {
    ...
    @GetMapping(path = {"/survey-unit/{id}/state-data", "/interrogation/{id}/state-data"})
    ...
    @PutMapping(path = {"/survey-unit/{id}/state-data", "/interrogation/{id}/state-data"})
    ...
    @PostMapping(path = {"survey-units/state-data", "interrogations/state-data"})

...
public class NomenclatureController {
    ...
    /**
     * Retrieve all required nomenclatures linked to a group
     *
    ...
    @PreAuthorize(AuthorityPrivileges.HAS_USER_PRIVILEGES)
    public List<String> getListRequiredNomenclature(@IdValid @PathVariable(value = "id") String groupId) {
        return nomenclatureService.findRequiredNomenclatureByGroup(groupId);
    }

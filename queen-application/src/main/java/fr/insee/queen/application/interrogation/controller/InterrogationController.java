...
public class InterrogationController {
    ...
    @GetMapping(path = {"/survey-units", "/interrogations"})
    ...
    @GetMapping(path = {"/admin/campaign/{id}/survey-units", "/admin/campaign/{id}/interrogations"})
    @PreAuthorize(AuthorityPrivileges.HAS_ADMIN_PRIVILEGES)
    public List<InterrogationState> getInterrogationsByState(
            @IdValid @PathVariable("id") String campaignId,
            @RequestParam(name="state") StateDataType stateDataType) {
        return interrogationService.getInterrogations(campaignId, stateDataType);
    }
    ...
    @GetMapping(path = {"/survey-unit/{id}", "/interrogation/{id}"})
    ...
    @GetMapping(path = {"/survey-unit/{id}/metadata", "/survey-unit/{id}/metadata"})
    @PreAuthorize(AuthorityPrivileges.HAS_USER_PRIVILEGES)
    ...
    @PutMapping(path = {"/survey-unit/{id}", "/interrogation/{id}"})
    ...
    @PostMapping(path = {"/campaign/{id}/survey-unit", "/campaign/{id}/interrogation"})
    @PreAuthorize(AuthorityPrivileges.HAS_ADMIN_PRIVILEGES)
    ...
    @PatchMapping(path = {"/survey-unit/{id}", "/interrogation/{id}"})
    ...
    @DeleteMapping(path = {"/survey-unit/{id}", "/interrogation/{id}"})
    @PreAuthorize(AuthorityPrivileges.HAS_ADMIN_PRIVILEGES)

...
class InterrogationsTempZoneIT {
    ...
    void on_create_interrogation_then_interrogation_created() throws Exception {
        String interrogationId = "interrogation-temp-11";
        ...
        mockMvc.perform(post("/api/survey-unit/" + interrogationId + "/temp-zone")
        ...
        String expressionFilter = "$[?(@.surveyUnitId == '" + interrogationId + "')]";
    ...
    @Test
    void on_get_survey_units_when_interrogationUser_then_return_403() throws Exception {
        // no control on questionnaire id ...
        mockMvc.perform(get("/api/survey-units/temp-zone")
                        .accept(MediaType.APPLICATION_JSON)

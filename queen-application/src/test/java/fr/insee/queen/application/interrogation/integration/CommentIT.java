...
class CommentIT {
    ...
    void on_update_comment_comment_is_updated() throws Exception {
        ...
        MvcResult result = mockMvc.perform(get("/api/survey-unit/" + interrogationId + "/comment")
                        .accept(MediaType.APPLICATION_JSON)
                        .with(authentication(authenticatedUserTestHelper.getInterrogationUser()))
                )
                .andExpect(status().isOk())
        ...
        mockMvc.perform(put("/api/survey-unit/" + interrogationId + "/comment")
                        .content(commentJson)
        ...
        result = mockMvc.perform(get("/api/survey-unit/" + interrogationId + "/comment")
                        .accept(MediaType.APPLICATION_JSON)
                        .with(authentication(authenticatedUserTestHelper.getInterrogationUser()))
                )
                .andExpect(status().isOk())

...
public class PilotageFakeComponent implements PilotageComponent {
    ...
    public static final String INTERROGATION1_ID = "pilotage-component-s1";
    public static final String INTERROGATION2_ID = "pilotage-component-s2";
    ...
    public List<InterrogationSummary> getInterrogationsByCampaign(String campaignId) {
        ...
        return List.of(
                new InterrogationSummary(INTERROGATION1_ID, "questionnaire-id", campaignSummary),
                new InterrogationSummary("s2", "questionnaire-id", campaignSummary)
        );
    }
    ...
    public List<Interrogation> getInterviewerInterrogations() {
        ...
        return List.of(
                new Interrogation(INTERROGATION1_ID, "campaign-id", "questionnaire-id",
                        JsonNodeFactory.instance.arrayNode(),
                        JsonNodeFactory.instance.objectNode(),
                        JsonNodeFactory.instance.objectNode(),
                        new StateData(StateDataType.INIT, 0L, "2#3")),
                new Interrogation(INTERROGATION2_ID, "campaign-id", "questionnaire-id",
                        JsonNodeFactory.instance.arrayNode(),
                        JsonNodeFactory.instance.objectNode(),
                        JsonNodeFactory.instance.objectNode(),
                        new StateData(StateDataType.INIT, 0L, "2#3"))

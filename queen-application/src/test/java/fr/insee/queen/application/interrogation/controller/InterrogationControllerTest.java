...
class InterrogationControllerTest {
    ...
    void testDiffUpdateInterrogationException() {
        // given
        InterrogationDataStateDataUpdateInput suInput = new InterrogationDataStateDataUpdateInput(null, new StateDataInput(StateDataTypeInput.INIT, 1L, "2.0"));
    ...
    void testDiffUpdateInterrogation04() throws LockedResourceException {
        ...
        assertThat(interrogationUpdated.stateData().date()).isEqualTo(suInput.stateData().date());

...
class MetadataIT {
    ...
    @Test
    void on_get_metadata_by_group_retrieve_correct_metadata() throws Exception {
    ...
    @Test
    void on_get_metadata_by_group_when_incorrect_identifier_group_format_id_return_400() throws Exception {
    ...
    @Test
    void on_get_metadata_by_group_when_non_existing_group_format_id_return_404() throws Exception {

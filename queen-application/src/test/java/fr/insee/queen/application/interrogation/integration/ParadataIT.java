...
class ParadataIT {
    ...
    void on_create_paradata_return_created() throws Exception {
        String paradataInput = """
                {
                    "idInterrogation": "517046b6-bd88-47e0-838e-00d03461f592",
                    "events": [
                        {
                            "page": "83",
                                "type": "click",
    ...
    @ParameterizedTest
    @ValueSource(strings = {"\"idInterrogation\": \"invalid-unit\",", "", "\"idInterrogation\": {},"})
    void on_create_paradata_when_interrogation_invalid_return_404(String interrogationJson) throws Exception {
        String paradataInput = """
                {
                """ + interrogationJson + """  
                    "events": [

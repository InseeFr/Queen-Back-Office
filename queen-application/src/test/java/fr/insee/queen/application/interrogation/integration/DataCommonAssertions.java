...
public class DataCommonAssertions {
    ...
    void cleanExtractedData() throws Exception {
        List<String> interrogationIds = List.of("11","12");
        ...
        for(String interrogationId : interrogationIds) {
            MvcResult result = mockMvc.perform(get("/api/survey-unit/" + interrogationId + "/data")
                            .accept(MediaType.APPLICATION_JSON)
    ...
    void on_update_data_data_is_updated() throws Exception {
        ...
        mockMvc.perform(put("/api/survey-unit/" + interrogationId + "/data")
                        .content(dataJson)
        ...
        result = mockMvc.perform(get("/api/survey-unit/" + interrogationId + "/data")
                        .accept(MediaType.APPLICATION_JSON)
                        .with(authentication(authenticatedUserTestHelper.getInterrogationUser()))
                )
                .andExpect(status().isOk())
    ...
    void updateCollectedData02() throws Exception {
        String interrogationId = "su-test-diff-data";
        String externalData = """
        ...
        mockMvc.perform(patch("/api/survey-unit/" + interrogationId)
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateCollectedData01() throws Exception {
        String interrogationId = "su-test-diff-without-collected-data";
        String externalData = """
           "EXTERNAL": {"LAST_BROADCAST": "12/07/1998"}""";
        String stateData = """
                {
    ...
    void updateCollectedDataError03() throws Exception {
        mockMvc.perform(patch("/api/interrogation/12")
                        .content("[]")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .with(authentication(authenticatedUserTestHelper.getInterrogationUser()))

...
import fr.insee.queen.application.group.dto.input.NomenclatureCreationData;
...
class NomenclatureIT{
    ...
    @Test
    void on_get_required_nomenclatures_return_nomenclatures_for_group() throws Exception {
    ...
    @Test
    void on_get_required_nomenclatures_when_group_not_exist_return_404() throws Exception {
    ...
    @Test
    void on_get_required_nomenclatures_when_group_id_invalid_return_400() throws Exception {

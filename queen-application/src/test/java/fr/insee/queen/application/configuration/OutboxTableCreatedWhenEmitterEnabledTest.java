...
/**
 * Integration test to verify that the outbox table IS created
 * when feature.cross-environment-communication.emitter is set to true.
 */
@SpringBootTest
@Testcontainers
...
class OutboxTableCreatedWhenEmitterEnabledTest {
    ...
    void shouldCreateOutboxTable() {
        // When emitter is enabled, the outbox table should exist
